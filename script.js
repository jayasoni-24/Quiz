const questions = [
    ...
    { question: "What is the capital of Italy?", correct: "Rome", options: ["Venice", "Rome", "Milan", "Florence"] },
    { question: "What is the capital of Germany?", correct: "Berlin", options: ["Hamburg", "Munich", "Berlin", "Frankfurt"] },
    { question: "What is the capital of Spain?", correct: "Madrid", options: ["Barcelona", "Madrid", "Seville", "Valencia"] }
];
...
function showResults() {
    ...
    if (score === questions.length) {
        ...
        resultContainer.classList.add('sparkle');
    } else {
